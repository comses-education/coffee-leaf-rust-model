...
deploy: build
	...
	echo "Copying singularity image to ${OSG_SUBMIT_NODE}:/public/${OSG_USERNAME}"
	rsync -avzP ${SINGULARITY_IMAGE_NAME} ${OSG_SUBMIT_NODE}:/public/${OSG_USERNAME}
